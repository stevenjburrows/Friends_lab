...
def test_favourite_tv_show
  ...
  # (e.g. the function likes_to_eat(@person2, "bread")
  # should return true, likes_to_eat(@person3, "spinach") should return false)
...
def test_add_friend
  ...
  result = check_friend_length(@person2)
  ...
  def test_remove_friend
    ...
    result = check_friend_length(@person4)
    assert_equal(2, result)
  end
...
def test_lending
  lending(@person1, @person2, 1)
  result1 = @person1[:monies]
